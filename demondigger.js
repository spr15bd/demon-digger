...
window.addEventListener("load",function() {
  ...
  */  
	var Q = window.Q = Quintus({ audioSupported: [ 'wav' ,'ogg', 'm4a', 'aac' ] }).include("Sprites, Scenes, Input, Anim, 2D, UI, Touch, Audio")
